...
import type { CreateSubtaskPayload, SubtaskStatus, AssignSubtaskPayload } from "../types/types";
...
export const useAssignSubtask = (userStoryId: string) => {
    ...
    return useMutation({
        mutationFn: ({ subtaskId, payload }: { subtaskId: string; payload: AssignSubtaskPayload }) =>
