...
import { meetingService, type ScheduleMeetingPayload } from "../services/meeting.service";
...
export function useMeetings(projectId?: string) {
    ...
    const scheduleMutation = useMutation({
        mutationFn: (payload: ScheduleMeetingPayload) => meetingService.scheduleMeeting(payload),
        onSuccess: () => {
