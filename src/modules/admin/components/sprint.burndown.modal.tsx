          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 mb-0">
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">Analytics</span>
              </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-4 bg-gray-50/50 rounded-2xl border border-gray-100">
              <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Ideal</p>
              <p className="text-[11px] font-bold text-gray-600 leading-snug">
                Uniform target burn rate.
              </p>
            </div>
            <div className="p-4 bg-gray-50/50 rounded-2xl border border-gray-100">
              <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Actual</p>
              <p className="text-[11px] font-bold text-gray-600 leading-snug">
                Real-time remaining work.
              </p>
            </div>
            <div className="p-4 bg-indigo-50/30 rounded-2xl border border-indigo-100/50">
              <p className="text-[9px] font-black text-indigo-400 uppercase tracking-widest mb-1">Insight</p>
