...
import { UserPlus, Mail, User, ArrowRight, Loader2, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10">
      ...
      <div className="mb-8 text-center md:text-left">
        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Expand Your Team</h1>
        <p className="text-gray-500 font-medium mt-1">Invite new members to collaborate on your projects.</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-indigo-50 p-6 rounded-[2rem] border border-indigo-100 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h3 className="text-indigo-900 font-bold text-lg mb-2">Member Role</h3>
              <p className="text-indigo-700/80 text-sm leading-relaxed font-medium">
                New members will be invited as <strong>Collaborators</strong>. They will be able to join projects and participate in sprints once they accept the email.
              </p>
            </div>
            {/* Decorative Icon */}
            <UserPlus size={120} className="absolute -bottom-6 -right-6 text-indigo-200 opacity-30 rotate-12" />
          </div>
          ...
          <div className="bg-emerald-50 p-6 rounded-[2rem] border border-emerald-100">
            ...
            <ul className="space-y-2">
              {['Unlimited Projects', 'Sprint Access', 'Task Assignment'].map((text, i) => (
                <li key={i} className="text-emerald-700/70 text-xs font-bold flex items-center gap-2">
