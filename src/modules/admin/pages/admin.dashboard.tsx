...
import { FolderOpen, Play, Clock, Trophy, ChevronRight, Plus, RefreshCw, Bell, Zap, ArrowUpRight } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Active Projects", value: dashboardStats?.activeProjects?.toString() || "0", icon: FolderOpen, color: "text-blue-600", bg: "bg-blue-50" },
    { label: "Running Sprints", value: dashboardStats?.runningSprints?.toString() || "0", icon: Play, color: "text-emerald-600", bg: "bg-emerald-50" },
    { label: "Pending Reviews", value: dashboardStats?.pendingReviews?.toString() || "0", icon: Clock, color: "text-orange-600", bg: "bg-orange-50" },
  ];
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-indigo-100 text-lg opacity-90 font-medium">
              You have <span className="text-white font-bold underline decoration-indigo-400 underline-offset-4">{dashboardStats?.pendingReviews || 0} reviews</span> pending for the current sprint. Your team is waiting for your feedback!
            </p>
          </div>
