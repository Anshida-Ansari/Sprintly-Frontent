...
export default function AdminWorkLogs() {
	...
	const { data: analyticsRes, isLoading } = useQuery({
		...
		queryFn: () =>
			workLogService.getAdminWorkLogs({
		...
		<div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
			...
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
				<div>
					...
					<p className="text-gray-500 mt-1 font-medium">
						Analyze productivity and track time allocation across the
						organization.
					</p>
				</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
					...
					<h3 className="text-3xl font-black text-gray-900">
						{analytics.hoursPerSprint?.length || 0}
					</h3>
					<p className="text-xs font-medium text-gray-400 mt-2">
									...
									<div key={userStats.userId}>
										...
										<div className="h-2 w-full bg-gray-50 rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${Math.min((userStats.totalHours / (analytics.totalHours || 1)) * 100, 100)}%`,
												}}
											/>
										</div>
									</div>
									...
									<div key={sprintStats.sprintId}>
										...
										<div className="h-2 w-full bg-gray-50 rounded-full overflow-hidden">
											<div
												...
												style={{
													width: `${Math.min((sprintStats.totalHours / (analytics.totalHours || 1)) * 100, 100)}%`,
												}}
											/>
										</div>
									</div>
