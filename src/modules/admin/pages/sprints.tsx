import { ChevronRight, LayoutGrid, Search, Zap } from "lucide-react";
		...
		<div className="max-w-6xl mx-auto space-y-10 pb-12 animate-in fade-in duration-500">
			...
			<div className="flex flex-col gap-2">
				...
				<p className="text-lg text-gray-500 font-medium max-w-2xl">
					Plan and monitor your agile iterations. Select a project to manage its
					specific milestones.
				</p>
			</div>
				...
				<div className="flex items-center gap-4">
					...
					<div>
						...
						<p className="text-sm text-gray-400 font-bold">
							Choose a project to manage its sprints
						</p>
					</div>
				</div>
