      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          ...
          <div className="text-center mt-4 text-sm">
            ...
            <span className={`font-semibold ${timeLeft < 60 ? "text-red-600" : "text-indigo-600"}`}>
              {formatTime(timeLeft)}
            </span>
          </div>
        ...
        <div className="text-center">
          ...
          >
            {isResending ? "Sending..." : canResend ? "Resend OTP" : `Resend in ${RESEND_COOLDOWN_SECONDS}s`}
          </button>
        </div>
        ...
        <div className="mt-8 flex items-start gap-2 text-xs text-gray-500">
          ...
          <p>Your security is our priority. This code is valid for 3 minutes.</p>
        </div>
      </div>
    </div>
  );
