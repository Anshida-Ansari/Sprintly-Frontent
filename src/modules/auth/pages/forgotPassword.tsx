...
import { ArrowRight, Loader2, Mail, ChevronLeft } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full bg-white flex flex-col font-sans antialiased text-slate-900">
            ...
            <nav className="p-8 flex justify-between items-center w-full max-w-7xl mx-auto">
                ...
                <Link to="/login" className="flex items-center gap-2 text-sm font-bold border-b-2 border-blue-600 pb-1 hover:text-blue-600 transition-colors">
                    <ChevronLeft size={14} />
                    BACK TO LOGIN
                </Link>
            </nav>
                ...
                <div className="w-full max-w-[480px]">
                    ...
                    <div className="mb-12 space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Recovery System</span>
                        </div>
                        <h1 className="text-5xl font-black tracking-tight leading-[0.9]">
                            FORGOT <span className="text-blue-600">ACCESS?</span><br />
                            RESET KEY.
                        </h1>
