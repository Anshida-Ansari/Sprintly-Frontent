...
import { ArrowRight, Loader2, KeyRound, Eye, EyeOff } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full bg-white flex flex-col font-sans antialiased text-slate-900">
            ...
            <nav className="p-8 flex justify-between items-center w-full max-w-7xl mx-auto">
                ...
                <Link to="/login" className="text-sm font-bold border-b-2 border-blue-600 pb-1 hover:text-blue-600 transition-colors uppercase tracking-widest">
                    Cancel Reset
                </Link>
            </nav>
                ...
                <div className="w-full max-w-[480px]">
                    ...
                    <div className="mb-12 space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Security Override</span>
                        </div>
                        <h1 className="text-5xl font-black tracking-tight leading-[0.9]">
                            NEW <span className="text-blue-600">KEY.</span><br />
                            SECURE ACCESS.
                        </h1>
                        <p className="text-slate-500 font-medium text-lg max-w-[340px]">
                            Update credentials for <span className="text-slate-900 font-bold">{email}</span>.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="group relative border-2 border-slate-100 rounded-2xl p-4 focus-within:border-blue-600 transition-all duration-300">
                            <div className="flex justify-between items-center mb-1">
                                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-focus-within:text-blue-600">New Access Key</p>
                                <button 
                                    type="button" 
                        ...
                        <div className="group relative border-2 border-slate-100 rounded-2xl p-4 focus-within:border-blue-600 transition-all duration-300">
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-focus-within:text-blue-600 mb-1">Confirm Access Key</p>
                            <input
                                type={showPassword ? "text" : "password"}
                                placeholder="••••••••"
