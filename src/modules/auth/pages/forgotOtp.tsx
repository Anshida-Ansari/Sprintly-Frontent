    ...
    return (
        <div className="min-h-screen w-full bg-white flex flex-col font-sans antialiased text-slate-900">
            ...
            <nav className="p-8 flex justify-between items-center w-full max-w-7xl mx-auto">
                ...
                <Link to="/forgot-password" className="flex items-center gap-2 text-sm font-bold border-b-2 border-blue-600 pb-1 hover:text-blue-600 transition-colors">
                    <ChevronLeft size={14} />
                    CHANGE EMAIL
                </Link>
            </nav>
                ...
                <div className="w-full max-w-[480px]">
                    ...
                    <div className="mb-12 space-y-4">
                        ...
                        <h1 className="text-5xl font-black tracking-tight leading-[0.9]">
                            CHECK YOUR <span className="text-blue-600">INBOX.</span><br />
                            VERIFY CODE.
                        </h1>
                        <p className="text-slate-500 font-medium text-lg max-w-[360px]">
                            Sent to <span className="text-slate-900 font-bold">{email}</span>. Enter the 6-digit access key below.
                        </p>
                    </div>
                    ...
                    <div className="space-y-8">
                        <div className="flex flex-col items-center">
                            <OtpInput
                                ...
                                ref={otpInputRef}
                            />
                            {error && <p className="mt-4 text-xs font-black uppercase tracking-widest text-red-500">{error}</p>}
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            >
                                {isResending ? "SENDING..." : canResend ? "RESEND NOW" : `RESEND IN ${RESEND_COOLDOWN_SECONDS}S`}
                            </button>
                        </div>
                    </div>
