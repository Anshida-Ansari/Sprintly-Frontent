...
import { ArrowRight, BarChart3, Calendar, CheckCircle, Code2, GitBranch, Shield, Users, Zap } from "lucide-react";
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-indigo-600 to-blue-600 rounded-2xl p-8 shadow-2xl transform rotate-1">
              <div className="bg-slate-900 rounded-lg p-6 text-left font-mono text-sm">
                ...
                <div className="text-green-400">$ git commit -m "Sprint complete"</div>
                <div className="text-blue-400 mt-2">[main 7a8c9d2] Sprint complete</div>
                <div className="text-gray-400 mt-1"> 12 files changed, 847 insertions(+)</div>
                <div className="text-green-400 mt-4">$ sprintly deploy --production</div>
                ...
                <div className="text-gray-400 mt-2">Team notified · Sprint #42 closed</div>
              </div>
            </div>
      ...
      <section id="about" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Sprintly?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Designed specifically for development teams who need more than just task boards. Sprintly brings together project management, collaboration, and developer tools in one unified platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-2xl border border-indigo-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Developer-First Design</h3>
              <p className="text-gray-600">
                Built by developers, for developers. Native Git integration, CLI support, and workflows that match how you actually work.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border border-blue-100">
              ...
              <p className="text-gray-600">
                Real-time updates, integrated meetings, and communication tools that keep everyone aligned without constant context switching.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-100">
              ...
              <p className="text-gray-600">
                Role-based permissions, audit logs, SSO support, and security features that scale with your organization.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: CheckCircle, title: 'Task Management', desc: 'Create, assign, and track tasks with custom workflows and priorities' },
              { icon: Users, title: 'Team Collaboration', desc: 'Real-time chat, comments, and notifications keep everyone in sync' },
              { icon: GitBranch, title: 'Git Integration', desc: 'Connect repositories, track commits, and link PRs to tasks automatically' },
              { icon: Calendar, title: 'Meeting Scheduling', desc: 'Built-in calendar and scheduling tools for standups and sprint planning' },
              { icon: BarChart3, title: 'Progress Tracking', desc: 'Visualize sprint velocity, burndown charts, and team performance' },
              { icon: Zap, title: 'Automation', desc: 'Automate workflows, notifications, and repetitive tasks to save time' }
            ].map((feature, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition border border-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-8 rounded-2xl border border-purple-100 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Super Admin</h3>
              <p className="text-gray-600 mb-4">
                Full platform control with organization-wide settings, billing management, and complete oversight of all projects and teams.
              </p>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-2xl border border-indigo-100 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Admin (Lead)</h3>
              <p className="text-gray-600 mb-4">
                Project leads manage sprints, assign tasks, track team progress, and schedule meetings while maintaining project visibility.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border border-blue-100 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Focus on coding with a clean interface for task tracking, PR linking, time logging, and seamless collaboration with the team.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:hello@sprintly.dev" className="hover:text-white transition">hello@sprintly.dev</a></li>
