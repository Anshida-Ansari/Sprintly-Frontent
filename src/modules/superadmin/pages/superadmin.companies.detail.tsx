...
import {
  ArrowLeft, Mail, Calendar, User, ShieldCheck,
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Company Email</p>
              ...
              <div className="space-y-1">
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${statusStyles[company.status as CompanyStatus] || statusStyles.pending
                  }`}>
                  {company.status}
                </span>
              </div>
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Registration Date</p>
                <div className="flex items-center gap-2 text-gray-700">
                  <Calendar className="w-4 h-4 text-gray-400" />
                  <span>{new Date(company.createdAt).toLocaleDateString(undefined, { dateStyle: 'long' })}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Owner Admin ID</p>
              ...
              <div className="pt-4 border-t border-gray-100">
                <p className="text-sm text-gray-500">
                  This company was created via the {company.source || 'Standard Web'} portal.
                </p>
              </div>
            </div>
          </div>
