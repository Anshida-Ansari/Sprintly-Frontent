...
export default function SuperAdminDashboard() {
  ...
  const stats = [
    { label: 'Total Companies', value: '45', subtext: 'of Companies', change: '+12%', trending: 'up', icon: Building2, color: 'blue' },
    { label: 'Active Users', value: '320', subtext: 'Users', change: '+8%', trending: 'up', icon: Users, color: 'green' },
    { label: 'Active Subscriptions', value: '80', subtext: 'Monthly Revenue: $12,500', change: '+15%', trending: 'up', icon: TrendingUp, color: 'purple' },
    { label: 'Total Users', value: '320', subtext: 'Users', change: '-2%', trending: 'down', icon: Users, color: 'orange' },
  ];
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6 mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">Monitor your platform's performance and key metrics</p>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`flex items-center gap-1 text-sm font-semibold ${stat.trending === 'up' ? 'text-green-600' : 'text-red-600'}`}>
                    {stat.trending === 'up' ? <ArrowUp size={16} /> : <ArrowDown size={16} />}
                    {stat.change}
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-gray-900">Subscription Growth Rate</h2>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-gray-900">Companies Joined Per Month</h2>
              <Building2 className="text-blue-600" size={20} />
            </div>
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-3xl font-bold text-blue-600">10</span>
              <span className="text-sm text-gray-500">Last 6 Months • +10%</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">Monthly Subscription Trends</h2>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Subscription Types Distribution</h2>
            <div className="space-y-5">
              {planDistribution.map((plan, index) => (
                <div key={index}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700">{plan.name}</span>
                    <span className="text-sm font-bold text-gray-900">{plan.count} ({plan.percentage}%)</span>
                  </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-orange-50 rounded-lg p-4">
              <p className="text-sm text-orange-600 font-medium mb-1">Churn Rate</p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Company/User</th>
                  ...
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        company.plan === 'Premium Plan' ? 'bg-purple-100 text-purple-700' :
                        company.plan === 'Standard Plan' ? 'bg-blue-100 text-blue-700' :
                        'bg-gray-100 text-gray-700'
                      }`}>
                        {company.plan}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{company.joined}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        company.status === 'registered' ? 'bg-green-100 text-green-700' :
