          ...
          <div className="flex-1 w-0 p-4">
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <p className="text-sm font-black text-gray-900">New Meeting Scheduled!</p>
                <p className="mt-1 text-sm text-gray-500 font-bold">{data.title}</p>
                <p className="mt-1 text-xs text-indigo-500 font-bold">{new Date(data.date).toLocaleString()}</p>
              </div>
            </div>
          </div>
