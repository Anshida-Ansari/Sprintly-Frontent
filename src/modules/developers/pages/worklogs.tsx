				...
				{logsLoading ? (
					...
					<div className="bg-white rounded-3xl border border-gray-100 p-24 flex flex-col items-center justify-center text-center">
						...
						<p className="text-gray-500 mt-2 max-w-xs">
							{searchTerm
								...
								: "Start logging your time to see your progress here."}
						</p>
					</div>
				) : (
					<div className="grid gap-4">
						{filteredLogs.map((log: any) => (
							<div
								key={log._id}
								className="group bg-white p-6 rounded-3xl border border-gray-100 hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-50/50 transition-all duration-300"
							>
								<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
									<div className="flex items-center gap-4 flex-1">
										...
										<div className="min-w-0">
											...
											<h4 className="font-bold text-gray-900 truncate">
												...
												<ArrowRight
													size={14}
													className="inline mx-1 text-gray-300"
												/>{" "}
												{log.subTaskId?.title}
											</h4>
											{log.description && (
