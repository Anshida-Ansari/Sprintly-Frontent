...
export const StandupForm = ({ projectId, sprintId, onClose }: StandupFormProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider block">What did you do yesterday?</label>
        <textarea
      ...
      <div className="space-y-2">
        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider block">What will you do today?</label>
        <textarea
          className="w-full bg-gray-50 border-transparent focus:bg-white focus:border-indigo-500 rounded-xl p-4 text-sm font-medium transition-all outline-none min-h-[80px] resize-none"
      ...
      <div className="space-y-2">
        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider block">Any blockers?</label>
        <textarea
