			...
			<div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
				<div className="space-y-2">
					...
					<p className="text-gray-500 font-medium">
						Track daily progress and identify blockers across projects.
					</p>
				</div>
				...
				{isLoading ? (
					...
					<div className="flex-1 bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 flex flex-col items-center justify-center py-20 text-center">
						...
						<p className="text-gray-400 font-medium max-w-sm mx-auto">
							Choose a project above to view daily sync progress and member
							updates.
						</p>
					</div>
								...
								<div className="p-7 space-y-6">
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-4">
											<div
												className={`w-14 h-14 rounded-2xl flex items-center justify-center font-black text-lg border shadow-sm transition-transform group-hover:scale-110 duration-500 ${isSubmitted ? "bg-indigo-600 text-white border-indigo-500 shadow-indigo-100" : "bg-gray-50 text-gray-400 border-gray-100"}`}
											>
					...
					<div className="flex-1 bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in-95 duration-500">
						...
						<p className="text-gray-400 font-medium max-w-sm mx-auto">
							This project doesn't have any members yet. Add members to see
							their standup logs.
						</p>
					</div>
				)}
					...
					<div className="flex items-center gap-6">
						<div className="flex items-center gap-2">
							...
							<span className="text-xs font-bold text-gray-500 uppercase tracking-widest">
								{submissionStats.submitted}/{submissionStats.total} Members
								Submitted
							</span>
						</div>
						<div className="flex items-center gap-2 text-indigo-600">
							...
							<span className="text-xs font-black uppercase tracking-widest">
								{standups?.length || 0} Total Updates
							</span>
						</div>
					</div>
					<div className="flex items-center gap-2">
